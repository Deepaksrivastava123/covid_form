...
import com.dotvik.covify.adapters.ExistingUsersDialogAdapter;
...
public class OptionsActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void openInstructionsActivity() {
        startActivity(new Intent(OptionsActivity.this, InstructionReadmeActivity.class));
    }

    private void openSupportActivity() {
        startActivity(new Intent(OptionsActivity.this, ContactSupportActivity.class));
    }
