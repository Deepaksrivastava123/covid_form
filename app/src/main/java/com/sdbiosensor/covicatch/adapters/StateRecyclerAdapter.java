...
public class StateRecyclerAdapter extends RecyclerView.Adapter<StateRecyclerAdapter.MyViewHolder> {
    private Context context;
    private JSONArray list;
    private OnItemClickListener listener;

    public StateRecyclerAdapter(Context context, JSONArray list, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        try {
            ...
            holder.text_item.setText(item.getString("State"));
        } catch (JSONException jsonException) {
            jsonException.printStackTrace();
        }
    }
